...
social:
  ...
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/bhawna-talwar-b0b8901b0?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BcwQgew2eTHmgQG8kmMkGbQ%3D%3D
  - icon: envelope
    icon_pack: fas
    link: 'mailto:bt577@drexel.edu'
  # - icon: twitter
  #   icon_pack: fab
  #   link:  
  # - icon: google-scholar
